...
const DashboardCardSuper = ({ data, type }: any) => {
  return (
    data !== null && (
      <Grid
            ...
            <Row justify={"space-between"}>
              ...
              >
                ...
                <Col style={{ display: "flex", flexDirection: "column" }}>
                  ...
                  >
                    {(parseFloat(data.total_amount) - parseFloat(data.owner_amount)).toFixed(2)}
                  </Typography.Text>
                  <Typography.Text
                    style={{
                      fontSize: "12px",
...
export default DashboardCardSuper;
